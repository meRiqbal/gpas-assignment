...
const ProductDetails: React.FC = () => {
  ...
  return (
    <div className="container mx-auto p-4">
      ...
      <button onClick={() => addToCart(product)} className="bg-green-500 text-white px-4 py-2 rounded mr-2">Add to Cart</button>
      <button onClick={() => router.push('/cart')} className="bg-blue-500 text-white px-4 py-2 rounded">Place Order</button>
    </div>
  );
};
